...
class LogoController extends Controller
{
    ...
    public function showPanelNegocioUserLogoAction(Request $request){
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $request->getSession()->getFlashBag()->add('success', 'Su logo fue actualizado !');
            return $this->redirectToRoute('profile_negocios_panel_gestion_negocio_cambiar_logo');
        }*/
    ...
    /**
     * @Route("/profile/panel/auth/logo/image-processing", name="processing_negocio_logo")
     */
    public function negocioFotoProfileProcessingShowAction(Request $request){
        $imagePath = $this->get('kernel')->getRootDir() . '/../web/images/negocios/logo/temps/' . $this->getRequest()->getBasePath();
    ...
    /**
     * @Route("/profile/panel/auth/logo/image-crop", name="crop_negocio_logo")
     */
